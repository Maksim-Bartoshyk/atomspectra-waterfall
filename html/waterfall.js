(function(){
    ...
    function getPointColor(cps, maxCps) {
        ...
        switch (waterfallState.palette) {
            case 'ygb':
                palette = ygbPaletteRGB.slice(10);
                break;
            case 'glow':
